...
export const metadata: Metadata = {
  title: 'Política de Reembolso - StencilFlow',
  description: 'Política de reembolso e cancelamento do StencilFlow.',
};
      ...
      <div className="space-y-8 text-zinc-300">
        ...
        <section>
          <p className="text-base leading-relaxed">
            No <strong className="text-white">StencilFlow</strong>, queremos que você esteja completamente satisfeito com nosso serviço. 
        ...
        <section>
          ...
          <div className="bg-emerald-900/20 p-6 rounded-lg border border-emerald-800">
            ...
            <p>
              Se você não estiver satisfeito com o StencilFlow nos primeiros <strong>7 dias</strong> após a assinatura, 
              oferecemos reembolso total do valor pago.
            </p>
          </div>

          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">1.1. Condições</h3>
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">1.2. Como Solicitar</h3>
          <ol className="list-decimal list-inside space-y-2 ml-4">
            <li>Envie email para <a href="mailto:contato@stencilflow.com.br" className="text-emerald-400 hover:underline">contato@stencilflow.com.br</a></li>
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">2.1. Situações Elegíveis</h3>
          <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">2.2. Reembolso Proporcional</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">2.3. Situações NÃO Elegíveis</h3>
          <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">3.1. Como Cancelar</h3>
          ...
          <p className="mt-4 text-sm">
            Ou envie email para <a href="mailto:contato@stencilflow.com.br" className="text-emerald-400 hover:underline">contato@stencilflow.com.br</a>
          </p>

          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">3.2. Efeitos do Cancelamento</h3>
          <ul className="list-disc list-inside space-y-2 ml-4">
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">6.1. Prazos</h3>
          <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <h3 className="text-xl font-semibold text-emerald-400 mt-6 mb-3">6.2. Método de Reembolso</h3>
          <p>
